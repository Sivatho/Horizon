    ...
    public class FetchPolicyStatusValidationMethods : AbstractValidationMethods, IFetchPolicyStatusValidationMethods
    {
        ...
        public void ValidateFetchPolicyStatusResponseDataIsNotNullOrEmpty(FetchPolicyStatusResponse fetchPolicyStatusResponse)
        {
            Assert.Multiple(() =>
            {
                ...
                Assert.That(fetchPolicyStatusResponse.executionOutcome.succeeded, Is.True, "FetchPolicyStatusResponse: executionOutcome.succeeded should be true");
            ...
            TestContext.Out.WriteLine("FetchPolicyStatusResponse: data is not null or empty or is greater or equal to zero as expected.");
        }
