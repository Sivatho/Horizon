...
{
    [TestFixture]
    public class GetStatementLineIDAPITests
    {
        ...
        public async Task Given_StatementLineIdRequestPayloadIsValid_When_GetStatementLineIDAsync_Then_ValidateGetStatementLineIDResponseIsOk()
        {
            //Arrange
            ...
            //Act
            var response = await accountHistoryAPIClient!.GetStatementLineIDAsync(request!);
            //Assert
        }
    }
}