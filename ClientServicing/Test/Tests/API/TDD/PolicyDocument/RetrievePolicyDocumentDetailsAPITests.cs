...
namespace ClientServicing.Test.Tests.API.TDD.PolicyDocument
{
    ...
    public class RetrievePolicyDocumentDetailsAPITests : RetrievePolicyDocumentDetailsValidationMethods
    {
        ...
        public async Task Given_RetrievePolicyDocumentDetailsRequestPayloadIsValid_When_RetrievePolicyDocumentDetailsAsync_Then_()
        {
            //Arrange 
                                        ...
                                        case "fileDetails":
                                            ...
                                            switch (fileDetailsElement.ValueKind)
                                            {
                                                ...
                                                case JsonValueKind.Null:
                                                    retrievePolicyDocumentDetailsResponse.fileDetails = null;
                                                    break;
